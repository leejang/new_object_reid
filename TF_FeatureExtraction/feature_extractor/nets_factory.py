...
networks_map = {'mobilenet_v1': mobilenet_v1,
                'mobilenet_v1_w_sa': mobilenet_v1_w_sa,
               }

arg_scopes_map = {'mobilenet_v1': mobilenet_v1_arg_scope,
                  'mobilenet_v1_w_sa': mobilenet_v1_w_sa_arg_scope,
                 }
